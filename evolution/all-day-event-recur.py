...
try:
    log ('Create Recursive All Day Event','teststart')
    selectCalendarPane ()
    ...
    create_appointment (datafilename, 'yes')
except:
    log ('Create Recursive All Day Event','fail')
    log ('Create Recursive All Day Event','testend')
    raise LdtpExecutionError (0)
log ('Create Recursive All Day Event','pass')
log ('Create Recursive All Day Event','testend')    
