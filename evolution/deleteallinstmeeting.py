...
try:
    log ('Delete all instance of recursive Meeting','teststart')
    try:
        ...
        log ('Delete all instance of recursive Meeting','fail')
    ...
    try:
        ...
        log ('Delete all instance of recursive Meeting','fail')
        raise LdtpExecutionError (0)
    log ('Delete all instance of recursive Meeting','pass')

except:
    log ('Delete all instance of recursive Meeting','testend')
    raise LdtpExecutionError (0)
log ('Delete all instance of recursive Meeting','testend')
